    ...
    <div class="container">
        <div class="row g-5">
            ...
            <div class="col-lg-6">
                ...
                <h3 class="h3 fw-bold mb-2  wow fadeInUp">Change Password</h3>
                <form action="<?= base_url()?>trainer/updatePassword" method="POST">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 mb-3">
                            <label class="mb-2">Old Password <span class="text-danger">*</span></label>
                            <input type="password" class="form-control" placeholder="Enter your old password" name="old_password" id="old_password" required/>
                        </div>
                        <div class="col-lg-12 col-md-12 mb-3">
                            <label class="mb-2">New Password <span class="text-danger">*</span></label>
                            <input type="password" class="form-control" placeholder="Enter your password" name="new_password" id="new_password" required/>
                        </div>
                        <div class="col-lg-12 col-md-12 mb-3">
                            <label class="mb-2">Confirm Password <span class="text-danger">*</span></label>
                            <input type="password" class="form-control" placeholder="Enter confirm password" name="confirm_password" id="confirm_password" required/>
                        </div>
                        <div class="col-lg-6 mb-3">
                            <button class="enrollbtn">Update Password</button>
