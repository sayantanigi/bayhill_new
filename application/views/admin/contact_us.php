        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div id="page-wrapper">
                        <div class="container-fluid">
                            <form action="" method="POST" enctype="multipart/form-data" id="submitContactus">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-8">
                                                        <div class="form-group mb-2">
                                                            ...
                                                            <input type="text" class="form-control" name="heading"  id="heading1"  autocomplete="off" value="<?php echo!empty($contactUs->heading) ? $contactUs->heading : ''; ?>">
                                                        </div>
                                                        ...
                                                        <div class="form-row mb-3 mt-3">
                                                            <div class="form-group col-md-12">
                                                                ...
                                                                <textarea name="description" id="description" class="form-control editor summermote">
                                                                    <?php echo!empty($contactUs->description) ? $contactUs->description : ''; ?>
                                                                </textarea>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group mb-2 files">
                                                            ...
                                                            <input type="hidden" class="form-control" name="id"  id="id"  value="<?php echo!empty($contactUs->id) ? $contactUs->id : ''; ?>">
                                                        </div><br/>
                                                        <div class="form-group mb-2 files">
                                                            <?php
                                                            if (!empty($contactUs->image)) {
                                                                $explodeImg = explode('.', @$contactUs->image);
                                                            ...
                                                            ?>
                                                            <img src="<?php echo!empty($contactUs->image) ? base_url('uploads/about_us/' . $contactUs->image . '') : base_url('uploads/noimage.jpg'); ?>" style="width: 30%;display:<?= (@$fileType == 1) ? 'block' : 'none'; ?>" id="blahImg" >
                                                            <video id="blahVideo" style="width: 30%;display:<?= (@$fileType == 2) ? 'block' : 'none'; ?>" controls><source src="<?php echo!empty($contactUs->image) ? base_url('uploads/about_us/' . $contactUs->image . '') : base_url('uploads/noimage.jpg'); ?>"  ></video>
                                                        </div><br/>
                                                        <div class="form-group mb-2">
                                                            <label class="fw-semibold  text-black">Status</label>
                                                            <select class="form-control" name="status"  id="userstatus">
                                                                <option value="">Select Status</option>
                                                                <option value="1" <?php echo (@$contactUs->status == 1) ? 'selected' : '' ?>>Active</option>
                                                                <option value="0" <?php echo (@$contactUs->status == 0) ? 'selected' : '' ?>>Inactive</option>
                                                            </select>
                                                        </div>
...
$(document).ready(function () {
    $("#submitContactus").on('submit', function (e) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url('admin/cms/saveContactus'); ?>',
