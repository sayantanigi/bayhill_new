        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div id="page-wrapper">
                        <div class="container-fluid">
                            <form method="POST" enctype="multipart/form-data" id="submitAboutus">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-8">
                                                        ...
                                                        <br/>
                                                        <div class="col-sm-6 col-sm-offset-2 mb-3">
                                                            <div class="form-group">
                                                                <button type="button" class="btn btn-success" name="submit" id="submit">Save</button>
                                                                <input type="hidden" class="form-control" name="id"  id="id"  value="<?php echo!empty($help->id) ? $help->id : ''; ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
...
$(document).ready(function () {
    $("#submit").on('click', function (e) {
        ...
        // Push Summernote content into textarea
        $('#description').val($('.editor').summernote('code'));

        var form = $("#submitAboutus")[0]; // Get form element
