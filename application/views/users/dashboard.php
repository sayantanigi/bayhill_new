                        ...
                        <td class="align-middle">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="<?= base_url() ?>assessmentreport?courseID=<?= base64_encode(@$course->id)?>&studentID=<?= base64_encode(@$userData->id)?>" target="_blank">Assessment Report</a></li>
                                    <?php } ?>
                                </ul>
                            </div>
                        </td>
