                                        ...
                                        <div class="form-group mb-2">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="text" class="form-control" name="state" id="state" value="<?= @$result->state ?>">
                                                </div>
                                                <div class="col-sm-6">
                                        ...
                                        <div class="form-group mb-2">
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="text" class="form-control" name="course_week" id="course_week" required autocomplete="off" value="<?= @$result->course_week ?>">
                                                </div>
                                                <div class="col-sm-6">
                                                    <label class="fw-semibold  text-black">Classes per Week</label>
                                                    <input type="text" class="form-control" name="class_week" id="class_week" required autocomplete="off" value="<?= @$result->class_week ?>">
                                                </div>
                                                <div class="col-sm-6">
                                            ...
                                            <div class="col-lg-12 mb-3">
                                                <div class="card rounded">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="mt-3" style="margin-top: 5px !important;">
                                                            <div class="tx-11 font-weight-bold mb-0 ">
                                                                <b>Course Description: </b><p class="text-muted" id="coursedescription" style="display: contents"><?= @$result->course_description ?></p>
                                                            </div>
                                                        </div>
                                                        <div class="mt-3" style="margin-top: 5px !important;">
                                                            <div class="tx-11 font-weight-bold mb-0 ">
                                                        ...
                                                        <div class="mt-3" style="margin-top: 5px !important;">
                                                            <div class="tx-11 font-weight-bold mb-0 ">
                                                                <b>Course Price: </b><p class="text-muted" id="courseprice" style="display: contents"><?= @$result->course_price ?></p>
                                                            </div>
                                                        </div>
                                                        <div class="mt-3" style="margin-top: 5px !important;">
                                                            <div class="tx-11 font-weight-bold mb-0 ">
