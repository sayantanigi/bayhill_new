<section class="enrollPnl">
    <div class="container">
        ...
        <h3 class="maintitle mb-5  wow fadeInUp">Plan your reservation based on<br/>
            your preferences</h3>
        <div class="boxDateSchdule">
            <form action="<?= base_url()?>payment_details" method="post">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="p-lg-5 p-3">
                            <div id="calendar-container" class="mt-0">
                                <div class="d-flex justify-content-center align-items-center sortingform selectTime mb-20">
                    ...
                    <div class="col-lg-6">
                        <div class="p-lg-5 p-3 h-100 boxoutput">
                            ...
                            <h2 class="h4 mb-15 fw-semibold">Course Name</h2>
